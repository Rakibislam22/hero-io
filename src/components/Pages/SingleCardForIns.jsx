...
const SingleCardForIns = ({ appData, handleLocalStorageData }) => {
    ...
    return (
        <div className='my-4 flex items-center justify-between md:p-4 p-2 md:gap-5 gap-2 bg-white rounded-sm'>
            <div className='flex items-center gap-5'>
                <div>
                    <img className='w-20 rounded-lg' src={image} alt="" />
                </div>
                <div c>
                    <h1 className='text-[#001931] md:text-xl font-semibold py-2'>{title}</h1>
                    <div className='flex items-center md:gap-5 gap-3'>
                        <div className='flex justify-center items-center text-[#00D390] gap-1'>
                            <img className='md:w-5 w-3' src={downImg} alt="" />
                        ...
                        <div className='flex justify-center items-center gap-1 text-[#FF8811]'>
                            <img className='md:w-5 w-3' src={ratingsImg} alt="" />
                            <p>{ratingAvg}</p>
                        </div>
                        <div>
